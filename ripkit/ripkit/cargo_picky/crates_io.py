...
def del_crate(crate: Union[list[str], str], dir=CLONED_CRATES_DIR) -> None:
...
def clone_crate(
    crate: Union[list[str], str], exist_ok=False, dir=CLONED_CRATES_DIR, debug=False
) -> None:
    """
    ...
    for single_crate in crate:
        ...
        if crate_path.exists() and not exist_ok:
            ...
            if debug:
                print(f"Removing crate path {crate_path}")
